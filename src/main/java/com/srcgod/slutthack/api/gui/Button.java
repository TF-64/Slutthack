...
public class Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        mc.fontRenderer.drawStringWithShadow(!binding ? module.name : "< PRESS KEY >", x + width / 2 - mc.fontRenderer.getStringWidth(!binding ? module.name : "< PRESS KEY >") / 2, y + height / 2 - 9 / 2, module.toggled && !binding ? new Color(0xFF00D7).hashCode() : -1);
    }
