package com.srcgod.slutthack.impl.modules.combat;
...
public class KillAura extends Module {
        public KillAura() {
            ...
            Slutt.instance.settingsManager.rSetting(new Setting("Range", this, 4.2, 1, 5, false));
            Slutt.instance.settingsManager.rSetting(new Setting("OnlyCritical", this, false));
        }
        ...
        public void onUpdate(RenderWorldLastEvent e) {
            ...
            boolean onlyCrits = Slutt.instance.settingsManager.getSettingByName(this.name, "OnlyCritical").getValBoolean();
