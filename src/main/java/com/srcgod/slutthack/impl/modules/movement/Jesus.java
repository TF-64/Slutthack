...
public class Jesus extends Module {
    ...
    public Jesus() {
        ...
        Slutt.instance.settingsManager.rSetting(new Setting("Speed", this, 2, 0.1, 3.0, false));
        Slutt.instance.settingsManager.rSetting(new Setting("Height", this, 0.1, 0.1, 3.0, false));
    }
    ...
    public void onPlayerTick(TickEvent.PlayerTickEvent e) {
        ...
        double range = Slutt.instance.settingsManager.getSettingByName(this.name, "height").getValDouble();
        double speed = Slutt.instance.settingsManager.getSettingByName(this.name, "speed").getValDouble();
